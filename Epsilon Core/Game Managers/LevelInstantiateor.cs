...
namespace Epsilon
{
    public sealed class StagePlayer
    {
        ...
        private static void CreateGround(int x, int y)
        {
            ...
            EpsilonKernal.InstantiateGameObject(tile);
        }
        private static void CreatePlayer()
        {
            ...
            playerComp.facingRight = AssetHelper.LoadImage("Epsilon.Dont_Melt_Core.Embedded_Items.Player.PlayerRight.png");
            playerComp.facingLeft = AssetHelper.LoadImage("Epsilon.Dont_Melt_Core.Embedded_Items.Player.PlayerLeft.png");
            ...
            EpsilonKernal.InstantiateGameObject(player);
        }
    }
}
