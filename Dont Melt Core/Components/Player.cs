namespace DontMelt
{
    public class Player : Component
    {
        ...
        public override void Initialize(InitializationInputPacket packet)
        {
        ...
        private void Jump(UpdateInputPacket packet)
        {
        ...
        private void Move(UpdateInputPacket packet)
        {
            int moveAxis = 0;
        ...
        private void Drag(UpdateInputPacket packet)
        {
        ...
        private void Collision(UpdateInputPacket packet)
        {
