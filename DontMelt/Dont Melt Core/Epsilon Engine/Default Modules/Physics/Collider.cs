...
namespace DontMelt
{
    public sealed class Collider : Item
    {
        ...
        public Rectangle shape = new Rectangle(Point.Zero, new Point(DontMeltKernal.pixelsPerUnit, DontMeltKernal.pixelsPerUnit));
        public Point offset = Point.Zero;
        public SideInfo sideCollision = SideInfo.True;
        public bool trigger = false;

        public override void Update(UpdateInputPacket packet)
        {
            Flush();
        }
        ...
        public static new Item Create(GameObject parent)
        {
        ...
        public static Item Create(GameObject parent, Rectangle shape)
        {
            Collider output = new Collider();
            output.offset = Point.Zero;
            output.trigger = false;
