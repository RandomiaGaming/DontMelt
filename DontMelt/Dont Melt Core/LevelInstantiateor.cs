namespace DontMelt
{
    public static class LevelInstantiateor
    {
        private static Texture groundTexture;
        public static void InstantiateLevel()
        {
            groundTexture = AssetLoader.LoadImage("DontMelt.Dont_Melt_Core.Embedded_Items.Ground.Ground.png");
            for (int i = 0; i < 16; i++)
            {
                CreateGround(i, 0);
            }
        ...
        private static void CreatePlayer()
        {
            ...
            playerComp.facingRight = AssetLoader.LoadImage("DontMelt.Dont_Melt_Core.Embedded_Items.Player.PlayerRight.png");
            playerComp.facingLeft = AssetLoader.LoadImage("DontMelt.Dont_Melt_Core.Embedded_Items.Player.PlayerLeft.png");
